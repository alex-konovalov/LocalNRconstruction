...
ubf := [];
disp := [,3,4,7,9,15,19,24]; # 1st entry is empty for the sake of indexation 
for j in [2..8] do
...
if x1+x2+x3+x4+x5+x6+x7+x8=i and disp[2]*x2+disp[3]*x3+disp[4]*x4+disp[5]*x5+disp[6]*x6+disp[7]*x7+disp[8]*x8=r1-i
